...
var GMPixi = __webpack_require__(23);
...
var undefined = __webpack_require__(4).undefined;
...
var query = __webpack_require__(10).stringify;
...
Object.defineProperty(Socket, 'emit', {
  enumerable: true,
  get: function() {
    return active ? active.emit : function() {}
  }
});
...
Object.defineProperty(Socket, 'on', {
  enumerable: true,
  get: function() {
    return active ? active.on : function() {}
  }
});
